...
@Component({
    ...
    <section class="auth-page">
      <div class="auth-card">
        <div class="logo-area">
          ...
          <h2>Bon retour !</h2>
          <p class="muted">Connectez-vous pour continuer votre voyage</p>
        </div>
        ...
        <p class="switch-auth">
          Nouveau sur GoTogether ? <a routerLink="/register">Créer un compte</a>
        </p>
      </div>
    </section>
  `,
  styles: [`
    ...
    .auth-page {
      ...
      padding: 2rem; 
      min-height: 90vh; 
      /* Fond doux et professionnel en accord avec le Hero de la Home */
    ...
    .switch-auth a:hover { color: #003d3d; }
  `]
})
